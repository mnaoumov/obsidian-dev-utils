...
export function mockCapacitorAdapter(): void {
  mockImplementation(CapacitorAdapter.prototype, 'constructor__', function initCapacitorAdapter(this: CapacitorAdapter, originalImplementation, basePath: string, fs: unknown): void {
