...
type FileCallback = (p: unknown) => void;
...
export declare class FileImporter extends Component {
  ...
  public reloadQueue: TFile[];
  /** Fast-access set which holds the list of files queued to be reloaded; used for debouncing. */
  public reloadSet: Set<string>;
  /** Paths -> promises for file reloads which have not yet been queued. */
  public callbacks: Map<string, [FileCallback, FileCallback][]>;
  public constructor(numWorkers: number, vault: Vault, metadataCache: MetadataCache);
  /**
