...
import type { ListItem,
  PageMetadata } from "../data-model/markdown.d.ts";
import type { Literal,
  Link } from "../data-model/value.d.ts";
import type { CachedMetadata,
  FileStats,
  FrontMatterCache,
  HeadingCache } from "obsidian";
...
export declare function splitFrontmatterTagOrAlias(data: unknown, on: RegExp): string[];
...
export declare function parseFrontmatter(value: unknown): Literal;
