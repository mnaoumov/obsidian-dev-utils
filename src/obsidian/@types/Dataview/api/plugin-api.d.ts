...
export declare class DataviewIOApi {
  ...
  public constructor(api: DataviewApi);
  /** Load the contents of a CSV asynchronously, returning a data array of rows (or undefined if it does not exist). */
  public csv(path: Link | string, originFile?: string): Promise<DataArray<DataObject> | undefined>;
...
export declare class DataviewApi {
  ...
  public constructor(app: App, index: FullIndex, settings: DataviewSettings, verNum: string);
  ...
  /**
     ...
     * task nesting.
     */
  public query(source: string | Query, originFile?: string, settings?: QueryApiSettings): Promise<Result<QueryResult, string>>;
  ...
  public queryMarkdown(source: string | Query, originFile?: string, settings?: Partial<QueryApiSettings & ExportSettings>): Promise<Result<string, string>>;
  /** Error-throwing version of {@link queryMarkdown}. */
  public tryQueryMarkdown(source: string | Query, originFile?: string, settings?: Partial<QueryApiSettings & ExportSettings>): Promise<string>;
  /**
  ...
  /**
     ...
     */
  public execute(source: string, container: HTMLElement, component: Component | MarkdownPostProcessorContext, filePath: string): Promise<void>;
  /**
     ...
     */
  public executeJs(code: string, container: HTMLElement, component: Component | MarkdownPostProcessorContext, filePath: string): Promise<void>;
  /** Render a dataview list of the given values. */
  public list(values: unknown[] | DataArray<unknown> | undefined, container: HTMLElement, component: Component, filePath: string): Promise<void>;
  /** Render a dataview table with the given headers, and the 2D array of values. */
  public table(headers: string[], values: unknown[][] | DataArray<unknown> | undefined, container: HTMLElement, component: Component, filePath: string): Promise<void>;
  /** Render a dataview task view with the given tasks. */
  public taskList(tasks: Grouping<SListItem>, groupByFile: boolean | undefined, container: HTMLElement, component: Component, filePath?: string): Promise<void>;
  /** Render an arbitrary value into a container. */
  public renderValue(value: unknown, container: HTMLElement, component: Component, filePath: string, inline?: boolean): Promise<void>;
  /** Render data to a markdown table. */
  public markdownTable(headers: string[] | undefined, values: unknown[][] | DataArray<unknown> | undefined, settings?: Partial<ExportSettings>): string;
