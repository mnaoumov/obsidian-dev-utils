...
export declare class FullIndex extends Component {
  ...
  private _initialize;
  public rename(file: TAbstractFile, oldPath: string): void;
  /** Queue a file for reloading; this is done asynchronously in the background and may take a few seconds. */
  public reload(file: TFile): Promise<{
    cached: boolean;
    skipped: boolean;
  }>;
...
export declare class PrefixIndex extends Component {
  ...
  public constructor(vault: Vault, updateRevision: () => void);
  private walk;
...
export declare class CsvCache extends Component {
  public vault: Vault;
  public static CACHE_EXPIRY_SECONDS: number;
  public cache: Map<string, {
    data: DataObject[];
    loadTime: DateTime;
  }>;
  public cacheClearInterval: number;
  public constructor(vault: Vault);
  /** Load a CSV file from the cache, doing a fresh load if it has not been loaded. */
  public get(path: string): Promise<Result<DataObject[], string>>;
...
export declare class StarredCache extends Component {
  ...
  public static INITIAL_DELAY: number;
  /** How frequently to check for star updates. */
  public static REFRESH_INTERVAL: number;
  /** Set of all starred file paths. */
  private stars;
  public constructor(app: App, onUpdate: () => void);
...
export declare class IndexMap {
  ...
  public map: Map<string, Set<string>>;
  /** Cached inverse map; maps value -> keys that reference that value. */
  public invMap: Map<string, Set<string>>;
