...
import type { LiteralReprAll,
  LiteralTypeOrAll } from "./binaryop.d.ts";
...
export declare class FunctionBuilder {
  public name: string;
  public variants: FunctionVariant[];
  public vectorized: Record<number, number[]>;
  ...
  public add1<T extends LiteralTypeOrAll>(argType: T, impl: (a: LiteralReprAll<T>, context: Context) => Literal): FunctionBuilder;
  /** Add a function variant which takes in two typed arguments. */
  public add2<T extends LiteralTypeOrAll, U extends LiteralTypeOrAll>(arg1: T, arg2: U, impl: (a: LiteralReprAll<T>, b: LiteralReprAll<U>, context: Context) => Literal): FunctionBuilder;
  /** Add a function variant which takes in three typed arguments. */
  public add3<T extends LiteralTypeOrAll, U extends LiteralTypeOrAll, V extends LiteralTypeOrAll>(arg1: T, arg2: U, arg3: V, impl: (a: LiteralReprAll<T>, b: LiteralReprAll<U>, c: LiteralReprAll<V>, context: Context) => Literal): FunctionBuilder;
