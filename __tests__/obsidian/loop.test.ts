...
import { addPluginCssClasses } from '../../src/obsidian/plugin/plugin-context.ts';
import { assertNonNullable } from '../../src/type-guards.ts';

vi.mock('../../src/abort-controller.ts', () => ({
...
describe('loop', () => {
  ...
  it('should use default abortSignal from abortSignalNever when none provided', async () => {
    const { abortSignalNever } = await import('../../src/abort-controller.ts');
