...
import { invokeAsyncAndLog } from '../../src/obsidian/Logger.ts';
...
vi.mock('../../src/Error.ts', async (importOriginal) => {
  const mod = await importOriginal<typeof import('../../src/Error.ts')>();
  return {
    ...mod,
