...
import type { ModalParamsBase } from '../../../src/obsidian/modals/modal-base.ts';

import {
  ModalBase,
  showModal
} from '../../../src/obsidian/modals/modal-base.ts';
...
describe('ModalBase', () => {
  ...
  it('should create a modal and apply plugin css classes', async () => {
    const { addPluginCssClasses } = await import('../../../src/obsidian/plugin/plugin-context.ts');
    const resolve = vi.fn();
