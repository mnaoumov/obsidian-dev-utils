...
import type { RetryWithTimeoutNoticeParams } from '../../src/obsidian/async-with-notice.ts';
...
vi.mock('../../src/obsidian/async-with-notice.ts', () => ({
...
vi.mock('../../src/obsidian/frontmatter-link-cache-with-offsets.ts', () => ({
...
const {
  ...
  unregisterFiles
} = await import('../../src/obsidian/metadata-cache.ts');
