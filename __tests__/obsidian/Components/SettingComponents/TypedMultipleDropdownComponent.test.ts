...
import { TypedMultipleDropdownComponent } from '../../../../src/obsidian/Components/SettingComponents/TypedMultipleDropdownComponent.ts';
...
describe('TypedMultipleDropdownComponent', () => {
  ...
  it('should call onChange callback when dropdown changes', () => {
    ...
    (comp as any).multipleDropdownComponent.dropdownComponent.simulateChange();
